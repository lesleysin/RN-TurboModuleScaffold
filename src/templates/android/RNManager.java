...
@ReactModule(name = TempNameManager.NAME)
public class TempNameManager extends SimpleViewManager<TempName>
        implements TempNameManagerInterface<TempName> {

    private final ViewManagerDelegate<TempName> mDelegate;

    static final String NAME = "TempName";

    public TempNameManager(ReactApplicationContext context) {
